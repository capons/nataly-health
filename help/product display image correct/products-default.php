				...
				<div class="media-list">
					...
					<?php foreach( $productItem->getRefItems( 'media', 'default', 'default' ) as $mediaItem ) : ?>
						...
						<?php if( $firstImage === true ) : $firstImage = false; ?>
							<noscript>
								<div class="media-item" style="background-image: url('<?php echo '/web'.$mediaUrl; ?>')" itemscope="" itemtype="http://schema.org/ImageObject">
									<meta itemprop="contentUrl" content="<?php echo '/web'.$mediaUrl; ?>" />
								</div>
							</noscript>
							<div class="media-item lazy-image" data-src="<?php
																		if (strpos($mediaUrl, 'http://demo.aimeos') !== false) {
																			echo $mediaUrl;
																		} else {
																			echo '/web'.$mediaUrl;
																		}
																		?>"></div>
						<?php else : ?>
							<div class="media-item" data-src="<?php
																		if (strpos($mediaUrl, 'http://demo.aimeos') !== false) {
																			echo $mediaUrl;
																		} else {
																			echo '/web'.$mediaUrl;
